...
- Slice 4, the dependency refresh, the UI/UX refinement, and the Slice 5 recovery/audio work are committed on `main`, which tracks `origin/main`; current Slice 6 work is uncommitted and no deployment exists.
