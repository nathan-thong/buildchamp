...
export function AppShell({ children, currentRoute }: AppShellProps) {
  const [muted, setMuted] = useState(() => readPreferences().muted);

  useEffect(() => {
    writePreferences({ version: 1, muted });
  }, [muted]);
      ...
      <footer className="site-footer">
        <div className="site-footer__inner">
          ...
          <p className="site-footer__notice">
            Unofficial fan project. Not endorsed by Riot Games. Riot Games and associated properties
